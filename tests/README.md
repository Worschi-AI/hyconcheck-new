...
|---|---|---|---|
| `check_repo_conventions.py` | Konventionsprüfung (kein Unit-Test): Pflichtdateien, Werkzeugneutralität, interne Links, Vollständigkeit des Master-Prompts, Wortlaut von H1–H7/F1–F6/AP-Inhalten, Planstunden, Taxonomie-Status, Forecast-Artefakte (`planning/forecast/`: Zeilenzahlen 386/66, keine Namensspalte, keine lokalen Pfade, AP-/Jahres-/Gesamtsummen, Tagessummen 0/8, Nicht-AP-Zeilen 0 h, AP-Titel-Konsistenz, SHA-256 und „keine Ist-Aussage“ im README, BL-090-Status), Rechercheprotokoll (`references/RESEARCH_PROTOCOL.md`: 16 Themencluster, Suchsysteme, Suchstrings, Ein-/Ausschluss, Screening, Provenienz- und Extraktionsfelder, Bias-Schutz, Stopkriterium; Vorlagen ohne unbelegte Literaturdaten; BL-001-Status), Literaturregister (`references/SOURCES.md`, `LITERATURE_MATRIX.csv`, `LITERATURE_SEARCH_LOG.md`: keine doppelten/leeren Source-IDs, Matrix ⊆ aufgenommene Quellen, DOI/URL-Syntax, dokumentierte Suchläufe, keine Hypothesenbewertung, Review A–E bei abgeschlossenem BL-002.1, BL-002/AP1 nicht abgeschlossen, Forschungslücke nicht bestätigt) | `py tests/check_repo_conventions.py` | anwendbar |
